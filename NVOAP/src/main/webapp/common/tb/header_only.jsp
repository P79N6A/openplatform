...
<body>
  <div class="header" data-spm="1" data-spm-max-idx="27">
    <div class="container clearfix">
      ...
      <ul class="nav" style="padding-left:84px;margin-left: 302px;margin-top: -50px;">
        <li class="nav-item">
      ...
      <!--<ul class="sub-nav single-col">
        ...
        <li class="nav-item">
          <a href="#" target="_blank" data-spm-anchor-id="a219a.7386653.1.26" onmouseover="this.style.color='#70bdff'" onmouseout="this.style.color='#fff'" style="color:#fff">进入开放平台</a>
        </li>
      </ul>
      <!-- <div class="user-info">
                        <span>
