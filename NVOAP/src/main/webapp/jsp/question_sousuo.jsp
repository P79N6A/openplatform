...
<ul class="search-type">
	<li class="selected">所有（${informDetails.size()})<li>
...
<ul class="search-result-list">
	<c:forEach var="informDetail" items="${informDetails}">
		<li>
			<h2><a href="/searchform/questionDetail?nd=${informDetail.id}" >${informDetail.informTitle}</a><h2>
			<p class="content" style="">${informDetail.informContent}</p>
...
$(function(){
	...
	$('.search-btn').click(function(){
		...
		window.location.href="/searchform/question?valz="+valz;
