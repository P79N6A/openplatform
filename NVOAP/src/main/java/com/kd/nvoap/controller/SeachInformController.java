...
public class SeachInformController {
	@Resource
	...
	public ModelAndView inform(HttpServletRequest request) {
		ModelAndView model = new ModelAndView("inform_sousuo");//加载新模型inform
		String valz=request.getParameter("valz");
		List<InformDetail> informDetails = informDetailService.getListByParam(valz);//从数据库中获取通知组名
		model.addObject("informDetails", informDetails);//填充左边栏通知组名
	...
	public ModelAndView question(HttpServletRequest request) {
		ModelAndView model = new ModelAndView("question_sousuo");//加载新模型inform
		String valz=request.getParameter("valz");
		List<InformDetail> informDetails = informDetailService.getListByParam(valz);//从数据库中获取通知组名
		model.addObject("informDetails", informDetails);//填充左边栏通知组名
	...
	public ModelAndView questionDetail(HttpServletRequest request) {
		ModelAndView model = new ModelAndView("question");//加载新模型inform
