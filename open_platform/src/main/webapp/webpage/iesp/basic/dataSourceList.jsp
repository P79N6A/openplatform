...
<script src=<%= request.getContextPath() + "/js/basic/DataSourceList.js" %> type="text/javascript"></script>
</head>
<body>
		...
		<form id="searchForm" class="searchForm" class="form-horizontal">
			<div class="form-horizontal col-xs-9 pull-left" role="form">
				<div class="col-xs-12 pull-left no-padding">
					...
					<div class="col-xs-4 form-group no-padding">
						<label class="col-sm-5 control-label near-padding-right" for="search_name">数据类型</label>
						<div class="col-sm-7 no-padding">
							<select class="selectpicker form-control" id="search_dsType">
                            	<option value="">全部</option>
