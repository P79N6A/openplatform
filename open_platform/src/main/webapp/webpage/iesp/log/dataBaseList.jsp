...
<script src=<%= request.getContextPath() + "/js/log/DataBaseList.js" %>
...
<body>
				...
				<div class="col-xs-12 pull-left no-padding">
					<div class="col-xs-4 form-group no-padding">
						<label class="col-sm-5 control-label near-padding-right"
							for="search_loglevel">日志区域</label>
						<div class="col-sm-7 no-padding">
							<select class="selectpicker form-control" id="search_type">
								<option value="">全部</option>
								<option value="1">信息外网</option>
								<option value="3">信息内网</option>
							</select>
						</div>
					</div>
					<div class="col-xs-4 form-group no-padding">
	...
	<table id="dataBaseLog"  style="table-layout:fixed"></table>
