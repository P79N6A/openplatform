...
<script src=<%= request.getContextPath() + "/js/system/roleList.js" %> type="text/javascript"></script>
</head>
<body>
			...
			<div class="form-horizontal col-xs-9 pull-left" role="form">
				<div class="col-xs-12 pull-left no-padding">
					<div class="col-xs-6 form-group no-padding">
						<label class="col-sm-5 control-label near-padding-right" for="search_roleName">角色名称</label>
						<div class="col-sm-7 no-padding">
							<input type="text" class="form-control" placeholder="角色名称" id="search_roleName">
						</div>
					</div>
				</div>
			</div>
