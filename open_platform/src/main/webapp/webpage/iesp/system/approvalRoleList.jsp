...
<script src="${pageContext.request.contextPath}/js/system/approvalRoleList.js" type="text/javascript"></script>
</head>
<body>
			...
			<div class="form-horizontal col-xs-9 pull-left" role="form">
				<div class="col-xs-12 pull-left no-padding">
					<div class="col-xs-6 form-group no-padding">                  	
                   	 		<label class="control-label col-sm-5" for="roleName">角色名称</label>
    ...
    <table id="approvalRoles"></table>
        <div class="modal" id="approvalRoleModal">
