...
<script src="${pageContext.request.contextPath}/js/system/sysSafeParamList.js" type="text/javascript"></script>
</head>
<body>
			...
			<div class="form-horizontal col-xs-9 pull-left" role="form">
				<div class="col-xs-12 pull-left no-padding">
					<div class="col-xs-6 form-group no-padding">                  	
                   	 		<label class="control-label col-sm-5" for="sysSafeCode">参数类型</label>
	                        <div class="col-sm-7 no-padding">
	                            <input type="text" class="form-control " placeholder="参数类型" id="sysSafeCode">
	                        </div>
	                 </div>       
	             </div>
    ...
    <table id="sysSafeParams"></table>
        <div class="modal" id="sysSafeParamModal">
