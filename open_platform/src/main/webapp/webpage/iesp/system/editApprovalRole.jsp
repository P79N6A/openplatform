...
<script src=<%= request.getContextPath() + "/js/system/editApprovalRole.js" %> type="text/javascript"></script>
</head>
<body>
	<div>
		    ...
		    <form id="addForm" name="addForm" method="post" class="form-horizontal" role="form">
		        ...
		        <div class="form-group">
		        	...
		        	<div class="col-sm-8" style="padding-right:0px">
		        		<input type="text" id="roleCode" name="roleCode" readonly="readonly" class="form-control" value="${role.roleCode}" />
		        	</div>
		        </div>
		       <div class="form-group">
