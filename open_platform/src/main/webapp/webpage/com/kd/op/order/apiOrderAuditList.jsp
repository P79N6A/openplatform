    ...
    var TableInit = function () {
        ...
        oTableInit.Init = function () {
            $('#apiOrderList').bootstrapTable({
                url: 'order.do?orderDatagrid&listType=audit', //请求后台的URL（*）
                method: 'post', //请求方式（*）
...
//                    },
    ...
    function goOrderAudit(id) {
        var dialog = bootOpenNormal('订单审核', 'order.do?goOrderAudit&id=' + id, 'normal');
    }
</script>
