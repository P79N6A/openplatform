...
<script type="text/javascript">
    ...
    var TableInit = function() {
        ...
        oTableInit.Init = function() {
            ...
            $('#chargeSceneList').bootstrapTable({
                url : 'sceneCharge.do?datagrid', //请求后台的URL（*）
                method : 'post', //请求方式（*）
                ...
                uniqueId : "appName", //每一行的唯一标识，一般为主键列
                sortName:'appName',
                sortOrder:'asc',
                columns : [
                    {
        ...
        oTableInit.queryParams = function(params) {
            var temp = { //这里的键的名字和控制器的变量名必须一直，这边改动，控制器也需要改成一样的
                ...
                field : 'restState,sceneName,appName'
            };

            var params = $("#chargeSceneForm").serializeArray();
            for (x in params) {
    ...
    function reloadTable() {
        $('#chargeSceneList').bootstrapTable('refresh');
    }
