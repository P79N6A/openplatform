...
<form class="form-horizontal" role="form" id="addForm" method="POST">
    ...
    <input id="apiInvokeType" name="apiInfo.apiInvokeType" value = "${apiInfoPage.apiInvokeType}" type="hidden" />
    <div id="smartwizard">
        <ul>
        ...
        <div>
                        ...
                        <div class="row">
                                    ...
                                    <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7 bt-content"
                                        ...
                                        <label class="checkbox-inline">
                                            <input id="apiInfo_pubMode1" type="radio"
                                                   name="apiInfo.pubMode" <c:if test="${fn:contains(apiInfoPage.pubMode, '0')}" >checked</c:if> value="0">HTTPS
                                        </label>
                                        <label class="checkbox-inline">
                                            <input id="apiInfo_pubMode2" type="radio"
                                                   name="apiInfo.pubMode"  <c:if test="${fn:contains(apiInfoPage.pubMode, '1')}">checked</c:if> value="1">HSF
                                        </label>
                                        <label class="checkbox-inline">
                                            <input id="apiInfo_pubMode3" type="radio"
                                                   name="apiInfo.pubMode"  <c:if test="${fn:contains(apiInfoPage.pubMode, '2')}">checked</c:if> value="2">WebService
                                        </label>
                                        <label class="checkbox-inline">
                                            <input id="apiInfo_pubMode4" type="radio"
                                                   name="apiInfo.pubMode" <c:if test="${fn:contains(apiInfoPage.pubMode, '3')}">checked</c:if> value="3">Dubbo
                                        </label>
                                        <label class="checkbox-inline">
                                            <input id="apiInfo_pubMode5" type="radio"
                                                   name="apiInfo.pubMode" <c:if test="${fn:contains(apiInfoPage.pubMode, '4')}">checked</c:if> value="4">MQ
                                        </label>
                                    </div>
                            ...
                            <div class="bt-item col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-7 col-sm-7 col-xs-7 bt-content">
                                        <input id="apiInfo_apiName" name="apiInfo.apiName" value = "${apiInfoPage.apiName}"  type="text" class="form-control" maxlength="100"  ignore="ignore"  />
                                    </div>
                                    <span class="col-lg-1 col-md-1 col-sm-1  Range"><span style="color:red">*</span></span>
                                </div>
                            </div>
                            ...
                            <div class="bt-item col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-7 col-sm-7 col-xs-7 bt-content">
                                        <input id="groupName" name="apiInfo.groupName"  type="text"  value = "${apiInfoPage.groupName}" class="form-control" readonly="readonly"/>
                                        <input id="groupSelect" name="apiInfo.groupId" value = "${apiInfoPage.groupId}" type="hidden"    />
                                    </div>
                                </div>
                            </div>
                            <div class="bt-item col-lg-12 col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="tab-content" style="background-color:#fff;padding-top:10px;">
                    <div class="tab-pane fade in active" id="headerParams" >
                        <iframe id="headerParamFrame" style="width:100%;min-height:300px"
                            src="apiInfoController.do?paramPage&loadType=2&paramType=2&apiId=${apiInfoPage.id}&ifId=headerParamFrame"></iframe>
                    </div>
                    <div class="tab-pane fade in" id="requestParams">
                        <iframe id="requestParamFrame" style="width:100%;min-height:300px"
                            src="apiInfoController.do?paramPage&loadType=2&paramType=0&apiId=${apiInfoPage.id}&ifId=requestParamFrame"></iframe>
                    </div>
                    <div class="tab-pane fade in" id="returnParams">
                        <iframe id="returnParamFrame" style="width:100%;min-height:300px"
                            src="apiInfoController.do?paramPage&loadType=2&paramType=1&apiId=${apiInfoPage.id}&ifId=returnParamFrame"></iframe>
                    </div>
                </div>
            </div>
            <div id="step-3" class="">
            ...
            <div id="step-4" class="">
                ...
                <ul class="nav nav-tabs nav-pills" role="tablist">
                    <li  role="presentation" class="active" data-type="1"><a href="#tactictsPer" aria-controls="home" role="tab" data-toggle="tab">按次计算</a></li>
            ...
            if (selectIds == "") {
                ...
                if (flowIds == "") {
                    ...
                    if (resourceIds == "" && $("#resourceCtrl").val() == 1) {
                        ...
                        var options = {
                            url: "apiInfoController.do?doUpdate",
                            type: "post",
                            dataType: "json",
