...
<script type="text/javascript">
    ...
    var TableInit = function () {
        ...
        oTableInit.Init = function () {
            $('#appOrderList').bootstrapTable({
                url: 'order.do?orderDatagrid&listType=order&OrderType=app', //请求后台的URL（*）
                method: 'post', //请求方式（*）
...
//                    },
    ...
    function reloadTable() {
        $('#appOrderList').bootstrapTable('refresh');
    }
    ...
    function goOrderDetailPage() {
        var selects = $('#appOrderList').bootstrapTable('getSelections');
