...
<div class="search-div row">
        ...
        <div class="col-xs-3" style="margin-top: 37px">
            <button type="button" class="btn btn-primary" id="search-btn" onclick="searchSceneInvoke()">
                <span class="glyphicon glyphicon-search"></span>查询
            </button>
            <button type="button" class="btn btn-warning" id="reset-btn" onclick="resetSceneInvoke()">
                <span class="glyphicon glyphicon-refresh"></span>重置
            </button>
        </div>
</div>
<div class="row" style="padding-top:20px">
    <div id="sceneInvokeCount" class="col-xs-6" style="height: 500px;">

    </div>
    <div id="sceneInvokeRanking" class="col-xs-6" style="height: 500px;">
...
<script type="text/javascript">
    ...
    //获取场景交易统计
    function sceneInvokeCount(){
        var sceneInvokeCount = echarts.init(document.getElementById('sceneInvokeCount'));  //初始化
        var optionCount={
            tooltip : {
                trigger : 'axis',
        ...
        $.ajax({
            ...
            url: "monitor.do?sceneInvokeCount",//后台处理程序,获取显示数据
            ...
            success:function(data){ //请求成功后处理函数。
                ...
                sceneInvokeCount.setOption(optionCount);
            }
        })
    }

    function searchSceneInvoke(){
    ...
    function sceneInvokeRanking(){
        var sceneInvokeRanking = echarts.init(document.getElementById('sceneInvokeRanking'));  //初始化
        var optionRanking = {
            title: {
                text: '场景调用排行',
                left : 'center',
        ...
        $.ajax({
            ...
            url: "monitor.do?sceneInvokeRanking",//后台处理程序,获取显示数据
            error: function () {//请求失败处理函数
                return false;
            },
            success:function(data){ //请求成功后处理函数。
                ...
                sceneInvokeRanking.setOption(optionRanking);
            }
        })
    }
