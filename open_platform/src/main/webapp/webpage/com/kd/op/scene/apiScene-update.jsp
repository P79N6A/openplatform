            ...
            <form class="form-horizontal" role="form" id="addForm" method="POST" >
                ...
                <div id="smartwizard">
                    ...
                    <div>
                                    ...
                                    <div class="row">
                                        <div class="bt-item col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="row">
                                                ...
                                                <div class="col-md-7 col-sm-7 col-xs-7 bt-content">
                                                    <input id="apiScene_sceneName" name="apiScene.sceneName" value="${apiScene.sceneName}" type="text" class="form-control input-sm" maxlength="100"  ignore="ignore"  />
                                                </div>
                                        ...
                                        <div class="bt-item col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="row">
                                                ...
                                                <div class="col-md-7 col-sm-7 col-xs-7 bt-content">
                                                    <input name="apiScene.sceneDes" value="${apiScene.sceneDes}" type="text" class="form-control input-sm" maxlength="200"  ignore="ignore"  />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div id="step-2" class="">
                            <input  id="apiInfoIds" name="apiInfoIds" type="hidden" value="${apiInfoIds}"/>
                            <div class="col-sm-2">
                        ...
                        <div id="step-3" class="">
                            <input id="chargeModeIds" name="chargeModeIds" type="hidden" value="${sceneChargeIds}"/>
                        ...
                        <div id="step-4" class="" id="resourceInfo">
                            <div class="bt-item col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="row">
                                    ...
                                    <div class="switch">
                                        <input type="checkbox" id="resourceCtrlBtn" <c:if test="${apiScene.resourceCtrl == 1}">checked</c:if>/>
                                    </div>
                                </div>
                                <hr>
                            ...
                            <input type="hidden" id="resourceCtrl" name="apiScene.resourceCtrl" value="${apiScene.resourceCtrl}"/>
...
<script type="text/javascript">
    ...
    var groupId = "";
    overAllIds = $("#apiInfoIds").val().split(",");
            ...
            if (document.getElementById("apiScene_sceneName").value == "") {
                ...
                if(selectIds == ""){
                    ...
                    if(apiSelectIds == ""){
                        ...
                        // } else {
                            var options = {
                                url: "apiSceneController.do?doUpdate",
                                type: "post",
                                dataType: "json",
...
// 				height : $(window).height() - 35, //行高，如果没有设置height属性，表格自动根据记录条数觉得表格高度
            ...
            onLoadSuccess : function(data) { //加载成功时执行
                //将已经选中的服务再次选中
                if(overAllIds != null && overAllIds != ""){
                    var ids = overAllIds;

                    $('#apiInfoList').bootstrapTable("checkBy", {field:"id", values:ids});
                }
