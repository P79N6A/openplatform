                ...
                <div class="panel panel-default" style="margin-bottom: 0px;">
                    <div class="panel-body">
                        <form id="apiOrderForm" onkeydown="if(event.keyCode==13){reloadTable();return false;}">
                            <div class="form-horizontal col-xs-12 pull-left" role="form">
                                    <div class="col-xs-12 col-sm-6 col-md-3">
                                        <label for="groupName">能力中心:</label>
                                        <div style="position: relative;">
                                            <%--<!-- 模拟select点击框 以及option的text值显示-->--%>
                                            <input id="groupName" class="form-control" style="height: 28px"  readonly />
                                            <%--<!-- 存储 模拟select的value值 -->--%>
                                            <input id="groupId" class="form-control" type="hidden" name="groupId" />
                                            <%--<!-- zTree树状图 相对定位在其下方 -->--%>
                            ...
                            <div class="col-xs-12 col-sm-6 col-md-2 pull-right no-padding">
...
<script type="text/javascript">
    ...
    var TableInit = function () {
        ...
        oTableInit.Init = function () {
            $('#orderLogList').bootstrapTable({
                url: 'order.do?queryApiDatagird', //请求后台的URL（*）
                method: 'post', //请求方式（*）
        ...
        oTableInit.queryParams = function (params) {
            var temp = { //这里的键的名字和控制器的变量名必须一直，这边改动，控制器也需要改成一样的
                ...
                field:'orderId,order_type,api_name,scene_name,app_name,create_name,create_date,pay_status,group_id,group_name'
            };
    ...
    function initGroupTree() {
        ...
        $.fn.zTree.init($("#groupIds"), setting, zNodes);
    ...
    function onBodyDownByActionType(event) {
        if (event.target.id.indexOf('groupIds') == -1){
