                    ...
                    <div class="panel-body">
                        <form id="apiAppForm" onkeydown="if(event.keyCode==13){reloadTable();return false;}">
                            <div class="col-xs-12 col-sm-6 col-md-4">
                                <label for="middleWareName">应用名称：</label>
                                <div class="input-group" style="width: 100%">
                                    <input type="text" class="form-control input-sm" id="middleWareName" name="middleWareName"/>
                                </div>
                            </div>
...
<div class="panel-body" style="padding-top: 0px; padding-bottom: 0px;">
    <div id="toolbar">
        <button onclick="bootOpenNormal('应用录入','apiAppController.do?goAdd','default')" id="btn_add" class="btn btn-primary btn-sm">
...
<script type="text/javascript">
    ...
    $("#btn_edit").bind("click",function(){
        var selects = $("#middle").bootstrapTable("getSelections");
        if(selects == null || selects.length == 0){
            ...
            var id = selects[0].id;
            bootOpenNormal('应用编辑','apiAppController.do?goUpdate&id=' + id,'normal');
        }
    })
    $("#btn_look").bind("click",function(){
        ...
        if(selects == null || selects.length == 0){
            ...
            var id = selects[0].id;
            bootOpenLook('应用查看','apiAppController.do?goUpdate&id=' + id,'normal')
        }
    })
    ...
    $(function() {
        ...
        $('#middle').on(
            ...
            function() {
                $('#btn_delete').prop('disabled',!$('#middle').bootstrapTable('getSelections').length);
                $('#btn_edit').prop('disabled',$('#middle').bootstrapTable('getSelections').length != 1);
            });
    ...
    var TableInit = function() {
        ...
        oTableInit.Init = function() {
            $('#middle').bootstrapTable({
                url : 'apiMiddleWare.do?datagrid', //请求后台的URL（*）
                method : 'post', //请求方式（*）
                ...
                columns : [
                    ...
                    },
                    {
                        ...
                        formatter : function(value,row, index) {
                            ...
                            var href = '';
                            href += "<button class='btn btn-xs btn-danger' style='margin-right:5px' title='删除' onclick='deleteApiApp(\"" + row.id + "\")'>" +
