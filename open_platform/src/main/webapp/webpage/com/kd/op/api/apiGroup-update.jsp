...
<head>
 ...
 <body>
	<t:formvalid formid="formobj" dialog="true" usePlugin="password" layout="table" action="apiGroupController.do?doUpdate" beforeSubmit="checkName()" tiptype="1" >
			<input type="hidden" id="btn_sub" class="btn_sub"/>
			<input type="hidden" name="id" value='${apiGroupPage.id}' >
			      ...
			      <div class="row form-wrapper">
					<div class="row show-grid">
			          <div class="col-xs-3 text-center">
						...
						<div class="col-xs-3">
							<input id="groupName" name="groupName" maxlength="32" type="text" class="form-control" datatype="*"  ignore="checked"  value='${apiGroupPage.groupName}' style="width:164px"/>
					...
					<div class="row show-grid">
			          <div class="col-xs-3 text-center">
						...
						<div class="col-xs-3">
						<c:if test="${look == 1}">
							<input id="parentName" name="parentName" type="text" class="form-control" value='${parentName}' style="width:164px"/>
						</c:if>
						<c:if test="${look != 1}">
					...
					<div class="row show-grid">
			          ...
			          <div class="col-xs-3">
						  	 	<textarea id="groupDesc" class="form-control" rows="6" style="width: 300px" name="groupDesc"  ignore="ignore" >${apiGroupPage.groupDesc}</textarea>
						<span class="Validform_checktip" style="float:left;height:0px;"></span>
