...
<div style="height:100%">
    ...
    <div class="tab-content" style="height:calc(100% - 48px)">
        <div role="tabpanel" class="tab-pane active" id="monthlyPayment">
            <iframe height="100%" width="100%" src="apiCharge.do?chargeAccountList&typename=com.kd.openplatform.charge.service.impl.ChargeByPeriodServiceImpl"></iframe>
        </div>
    ...
    $(document).ready(function(){
        $("#payPer-li,#payByFlow-li").bind("click",function(){
            ...
            if(html == null || html == undefined || html == ""){
                ...
                $(contentDiv).html("<iframe height=\"100%\" width=\"100%\" src=\"apiCharge.do?chargeAccountList&typename=" + typename + "\"></iframe>");
            }
        });
    })
</script>
