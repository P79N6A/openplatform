...
<script type="text/javascript">
    ...
    $('#apiInfoList1').bootstrapTable({
        ...
        queryParams: function (params) {
            var temp = { //这里的键的名字和控制器的变量名必须一直，这边改动，控制器也需要改成一样的
                ...
                field: 'id,apiName,apiStatus,groupName,resourceCtrl,createDate,apiPublishStatus,apiInvokeType,pubMode,resourceCtrl'
            };
   ...
   /* function configResource(id) {
        var dia = new BootstrapDialog({
            ...
            closable: false,
            data: {
                'pageToLoad': "resourceController.do?selectResource&id=" + id + "&level=2&type=api"+"&orderId="+'${orderId}'
            },
            buttons: [{
                label: '取消',
                cssClass: 'btn-default',
