...
<div class="search-div row">
        ...
        <div class="col-xs-3" style="margin-top: 37px">
            <button type="button" class="btn btn-primary" id="search-btn" onclick="searchApiOrder()">
                <span class="glyphicon glyphicon-search"></span>查询
            </button>
            <button type="button" class="btn btn-warning" id="reset-btn" onclick="resetApiOrder()">
                <span class="glyphicon glyphicon-refresh"></span>重置
            </button>
        </div>
</div>
<div class="row" style="padding-top:20px">
    <div id="apiOrderCount" class="col-xs-6" style="height: 500px;">

    </div>
    <div id="apiOrderRanking" class="col-xs-6" style="height: 500px;">
...
<script type="text/javascript">
    ...
    var groupId = "";
    //获取场景交易统计
    function apiOrderCount(){
        var apiOrderCount = echarts.init(document.getElementById('apiOrderCount'));  //初始化
        var optionCount={
            tooltip : {
                trigger : 'axis',
        ...
        $.ajax({
            ...
            url: "monitor.do?apiOrderCount",//后台处理程序,获取显示数据
            ...
            success:function(data){ //请求成功后处理函数。
                ...
                apiOrderCount.setOption(optionCount);
            }
        })
    }

    function searchApiOrder(){
    ...
    function apiOrderRanking(){
        var apiOrderRanking = echarts.init(document.getElementById('apiOrderRanking'));  //初始化
        var optionRanking = {
            title: {
                text: '能力购买排行',
                left : 'center',
        ...
        $.ajax({
            ...
            url: "monitor.do?apiOrderRanking",//后台处理程序,获取显示数据
            error: function () {//请求失败处理函数
                return false;
            },
            success:function(data){ //请求成功后处理函数。
                ...
                apiOrderRanking.setOption(optionRanking);
            }
        })
    }
