            ...
            <div class="accordion-inner">
                <div class="panel panel-default" style="margin-bottom: 0px;">
                    <div class="panel-body">
                        <form id="sceneOrderForm" onkeydown="if(event.keyCode==13){reloadTable();return false;}">
                            <div class="col-xs-6 col-sm-3 col-md-3">
                                <label for="sceneId">场景:</label>
                                <div class="input-group" style="width: 100%">
                                    <%--<select class="js-data-example-ajax form-control" name="appId" style="width: 100%"
                                            id="appId">
                                    </select>--%>
                                    <select class="selectpicker form-control" name="sceneId" style="overflow:auto;height: 200px;width: 100%"
                                            id="sceneId">
                                    </select>
                                </div>
                            </div>
...
<script type="text/javascript">
    ...
    var TableInit = function () {
        ...
        oTableInit.Init = function () {
            $('#orderLogList').bootstrapTable({
                url: 'order.do?querySceneDatagird', //请求后台的URL（*）
                method: 'post', //请求方式（*）
        ...
        oTableInit.queryParams = function (params) {
            ...
            var params = $("#sceneOrderForm").serializeArray();
            for (x in params) {
    ...
    function searchRest(){
        $('#sceneOrderForm').find(':input').each(function () {
        ...
        $('#sceneOrderForm').find("input[type='checkbox']").each(function () {
            $(this).attr('checked', false);
        });
        $('#sceneOrderForm').find("input[type='radio']").each(function () {
            $(this).attr('checked', false);
        });
