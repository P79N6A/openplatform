    ...
    <div id="smartwizard">
        ...
        <div>
                        ...
                        <div class="row">
                            <div class="bt-item col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-7 col-sm-7 col-xs-7 bt-content">
                                        <input  name="apiInfo.apiName" value = "${apiInfoPage.id}"  type="text" class="form-control" maxlength="100"  ignore="ignore"  />
                                    </div>
                                </div>
                            </div>
                            <div class="bt-item col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <div class="bt-item col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="row">
                                    ...
                                    <div class="col-md-7 col-sm-7 col-xs-7 bt-content">
                                        <input name="apiInfo.apiDesc" value = "${apiInfoPage.apiDesc}" type="text" class="form-control" maxlength="200"  ignore="ignore"  />
                                    </div>
                                </div>
                            </div>
                            <div class="bt-item col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            ...
                            <c:if test="${fn:contains(apiInfoPage.pubMode, '0') }">
                                <div class="bt-item col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="row">
                                        <div class="col-md-3 col-sm-3 col-xs-3 bt-label">
                                            HTTPS地址：
                                        ...
                                        <div class="col-md-7 col-sm-7 col-xs-7 bt-content">
                                            <input id="reqAddrHttp" name="apiInfo.reqAddrHttp" value = "${httpsAddr}" type="text" class="form-control" maxlength="200"  ignore="ignore"  />
                                        </div>
                                    </div>
                                </div>
                            </c:if>
                            <c:if test="${fn:contains(apiInfoPage.pubMode, '1')}">
                                <div class="bt-item col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="row">
                                        <div class="col-md-3 col-sm-3 col-xs-3 bt-label">
                                            hsf请求地址：
                            ...
                            <c:if test="${fn:contains(apiInfoPage.pubMode, '2')}">
                                <div class="bt-item col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                    <div class="row">
                                        <div class="col-md-3 col-sm-3 col-xs-3 bt-label">
                                            webservice接口标识：
                            ...
                            <c:if test="${fn:contains(apiInfoPage.pubMode, '4') }">
                            <div class="bt-item col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                <div class="row">
                                    <div class="col-md-3 col-sm-3 col-xs-3 bt-label">
                                        Topic：
                                ...
                                <c:if test="${apiInfoPage.apiInvokeType == 1 || empty apiInfoPage.apiInvokeType}">
                                    <%--<div class="bt-item col-lg-12 col-md-12 col-sm-12 col-xs-12">--%>
                                        <%--<div class="row">--%>
                                            ...
                                            <%--</div>--%>
                                            <%--<div class="col-md-7 col-sm-7 col-xs-7 bt-content">--%>
                                                <%--<input id="hsfGroup" name="apiInfo.hsfGroup" value = "${apiInfoPage.hsfGroup}" type="text" class="form-control" maxlength="30"  ignore="ignore"  />--%>
                                            <%--</div>--%>
                                        <%--</div>--%>
                                    <%--</div>--%>
                                    <div class="bt-item col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                        <div class="row">
                                            ...
                                            <div class="col-md-7 col-sm-7 col-xs-7 bt-content">
                                                <input id="version" name="apiInfo.version" value = "${apiInfoPage.version}" type="text" class="form-control" maxlength="30"  ignore="ignore"  />
                                            </div>
                                        </div>
                                    </div>
                                    <%--<div class="bt-item col-lg-12 col-md-12 col-sm-12 col-xs-12">--%>
                                        <%--<div class="row">--%>
                                            ...
                                            <%--</div>--%>
                                            <%--<div class="col-md-7 col-sm-7 col-xs-7 bt-content">--%>
                                                <%--<input id="apiClassName" name="apiInfo.apiClassName" value = "${apiInfoPage.apiClassName}" type="text" class="form-control" maxlength="80"  ignore="ignore"  />--%>
                                            <%--</div>--%>
                                        <%--</div>--%>
                                    <%--</div>--%>
                                    <%--<div class="bt-item col-lg-12 col-md-12 col-sm-12 col-xs-12">--%>
                                        <%--<div class="row">--%>
                                            ...
                                            <%--</div>--%>
                                            <%--<div class="col-md-7 col-sm-7 col-xs-7 bt-content">--%>
                                                <%--<input id="apiMethodName" name="apiInfo.apiMethodName" value = "${apiInfoPage.apiMethodName}" type="text" class="form-control" maxlength="30"  ignore="ignore"  />--%>
                                            <%--</div>--%>
                                        <%--</div>--%>
                                    <%--</div>--%>
                                </c:if>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-7 col-sm-7 col-xs-7 bt-content">
                                        <label class="checkbox-inline">
                                            <input type="checkbox" name="apiInfo.pubMode" <c:if test="${fn:contains(apiInfoPage.pubMode, '0')}">checked</c:if> value="0">HTTPS
                                        </label>
                                        <label class="checkbox-inline">
                                            <input type="checkbox" name="apiInfo.pubMode" <c:if test="${fn:contains(apiInfoPage.pubMode, '1')}">checked</c:if> value="1">HSF
                                        </label>
                                        <label class="checkbox-inline">
                                            <input type="checkbox" name="apiInfo.pubMode" <c:if test="${fn:contains(apiInfoPage.pubMode, '2')}">checked</c:if> value="2">WebService
                                        </label>
                                        <label class="checkbox-inline" style="margin-left:0px;">
                                            <input type="checkbox" name="apiInfo.pubMode" <c:if test="${fn:contains(apiInfoPage.pubMode, '3')}">checked</c:if> value="3">Dubbo
                                        </label>
                                        <label class="checkbox-inline" style="margin-left:0px;">
                                            <input type="checkbox" name="apiInfo.pubMode" <c:if test="${fn:contains(apiInfoPage.pubMode, '4')}">checked</c:if> value="4">MQ
                                        </label>
                                    </div>
                                </div>
                            </div>
            ...
            <div id="step-4" class="">
                ...
                <ul class="nav nav-tabs nav-pills" role="tablist">
                    <li role="presentation" class="active" data-type="1"><a href="#tactictsByPer" aria-controls="home" role="tab" data-toggle="tab">按次收费</a></li>
                    <li role="presentation" data-type="2"><a href="#tactictsByFlow" aria-controls="profile" role="tab" data-toggle="tab">按流量收费</a></li>
                </ul>
            ...
            <div id="step-5" class="" id="resourceInfo">
                <div class="bt-item col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <%--<div class="row">--%>
                        ...
                        <%--</div>--%>
                        <%--<div class="switch">--%>
                            <%--<input type="checkbox" id="resourceCtrlBtn" <c:if test="${apiInfoPage.resourceCtrl == 1}">checked</c:if>/>--%>
                        <%--</div>--%>
                    <%--</div>--%>
                    <%--<hr>--%>
                ...
                <%--<input type="hidden" id="resourceCtrl" name="apiInfo.resourceCtrl" value="${apiInfoPage.resourceCtrl}"/>--%>
                <%--<input  id="resourceAccessIds" name="resourceAccessIds" type="hidden" value="${resourceAccessIds}"/>--%>
            </div>
        </div>
    </div>
</form>
