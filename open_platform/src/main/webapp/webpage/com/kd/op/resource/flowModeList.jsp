...
<div class="panel-body" style="padding-top: 0px; padding-bottom: 0px;">
    ...
    <div id="toolbar">
        <button id="btn-add" class="btn btn-primary btn-sm" onclick="bootOpenNormal('流量控制策略录入','resourceController.do?flowgoAdd&type=${type}','normal')">
    ...
    $(function() {
        ...
        $("#btn-edit").bind("click",function(){
            ...
            if(selects == null || selects.length == 0){
                ...
                var id = selects[0].id;
                bootOpenNormal('流量控制策略编辑','resourceController.do?flowEdit&type=${type}&id=' + id + '','normal');
            }
        })
...
//                $('#chargeModeList').bootstrapTable("hideColumn","price");
//            }else if(type == 2){
//                $('#chargeModeList').bootstrapTable("hideColumn","num");
//                $('#chargeModeList').bootstrapTable("hideColumn","price");
//            }
            ...
            callback: function (result) {
                if(result) {
                    $.ajax({
                        type:"post",
                        dataType:"json",
                        url:"resourceController.do?flowdelete",
                        data:{id:id},
