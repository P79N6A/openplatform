        ...
        <div class="row">
            <form id="loinForm" class="login-input form-horizontal" role="form" method="post">
                ...
                <div class="input-password">
                    <span class="login-icon"></span>
                    <input type="password" name="password" class="form-control" placeholder="请输入您的密码" id="password"/>
                </div>
                ...
                <div class="loginbtn">
                    ...
                    <button type="button"
                            style="width:120px;background-color:#2869FB;border-color:#2869FB;border-radius:8px"
                            id="but_register" class="btn btn-sm btn-warning">
...
<script type="text/javascript">
    ...
    //获取密钥和随机数
        ...
        DwrMessagePush.prepareLogin(userName, function (data) {
            ...
            var actionurl = "isvLogin.do?login";//提交路径
        ...
        //密码进行加密
            password = doCrypt(password, passKey);
