...
<script type="text/javascript" src="<%=request.getContextPath() + "/webpage/isv/hplushome-developer.js"%>"></script>
</head>
                ...
                <div class="panel pannel-default monitor-summary-module-title">
                    <div class="pannel-body">
                        ...
                        <div href="#" class="col-lg-2 summary-module display-inline">
                            <span class="summary-font alarmFontMargin">ISV总数</span>
                            <span class="summary-num"><a ui-sref="app.cloud-monitor-instance({tabid: product.type})" class="color-a alarmNumberSize ng-binding" href="#/app/monitor-cloud-product?tabid=ECS">43</a>
                            </span>
                        </div>
                        ...
                        <div class="col-lg-2 summary-module">
                            ...
                            <span class="summary-num"><a ui-sref="app.cloud-monitor-alarm({status: 'INSUFFICIENT_DATA', tabid: product.type})" class="color-d alarmNumberSize ng-binding" href="#/app/monitor-alarmmngt-allproduct?status=INSUFFICIENT_DATA&amp;tabid=ECS">2</a>
                            </span>
                        </div>
                        <div class="col-lg-2 summary-module">
                            <span class="summary-font border-r alarmFontMargin">暂停数</span>
                            <span class="summary-num"><a ui-sref="app.cloud-monitor-alarm({startStatus: 'false', tabid: product.type})" class="color-e alarmNumberSize ng-binding" href="#/app/monitor-alarmmngt-allproduct?tabid=ECS&amp;startStatus=false">0</a>
                            </span>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-12 margin-t init">
                <div class="panel pannel-default monitor-summary-module-title">
                    <div class="pannel-body">
                        ...
                        <div href="#" class="col-lg-2 summary-module display-inline">
                            <span class="summary-font alarmFontMargin">API总数</span>
                            <span class="summary-num"><a ui-sref="app.cloud-monitor-instance({tabid: product.type})" class="color-a alarmNumberSize ng-binding" href="#/app/monitor-cloud-product?tabid=ECS">96</a>
                        </span>
                        </div>
                        <div class="col-lg-2 summary-module">
                            <span class="summary-font alarmFontMargin">能力中心数</span>
                            <span class="summary-num"><a ui-sref="app.cloud-monitor-alarm({tabid: product.type})" class="color-b alarmNumberSize ng-binding" href="#/app/monitor-alarmmngt-allproduct?tabid=ECS">2</a>
                        </span>
                        </div>
                        <div class="col-lg-2 summary-module">
                            <span class="summary-font alarmFontMargin">在运API数</span>
                            <span class="summary-num"><a ui-sref="app.cloud-monitor-alarm({status: 'ALARM', tabid: product.type})" class="color-c alarmNumberSize ng-binding" href="#/app/monitor-alarmmngt-allproduct?status=ALARM&amp;tabid=ECS">95</a>
                        </span>
                        </div>
                        <div class="col-lg-2 summary-module">
                            <span class="summary-font alarmFontMargin">故障/暂停数</span>
                            <span class="summary-num"><a ui-sref="app.cloud-monitor-alarm({status: 'INSUFFICIENT_DATA', tabid: product.type})" class="color-d alarmNumberSize ng-binding" href="#/app/monitor-alarmmngt-allproduct?status=INSUFFICIENT_DATA&amp;tabid=ECS">1</a>
                        </span>
                        </div>
                        <%--<div class="col-lg-2 summary-module">
                ...
                <div class="panel pannel-default monitor-summary-module-title">
                    <div class="pannel-body">
                        ...
                        <div href="#" class="col-lg-2 summary-module display-inline">
                            ...
                            <span class="summary-num"><a ui-sref="app.cloud-monitor-instance({tabid: product.type})" class="color-a alarmNumberSize ng-binding" href="#/app/monitor-cloud-product?tabid=ECS">1</a>
                            </span>
                        </div>
                        <div class="col-lg-2 summary-module">
                            <span class="summary-font alarmFontMargin">调用数</span>
                            <span class="summary-num"><a ui-sref="app.cloud-monitor-alarm({tabid: product.type})" class="color-b alarmNumberSize ng-binding" href="#/app/monitor-alarmmngt-allproduct?tabid=ECS">11350</a>
                            </span>
                        </div>
                        <div class="col-lg-2 summary-module">
                            <span class="summary-font alarmFontMargin">流量总计</span>
                            <span class="summary-num"><a ui-sref="app.cloud-monitor-alarm({status: 'ALARM', tabid: product.type})" class="color-c alarmNumberSize ng-binding" href="#/app/monitor-alarmmngt-allproduct?status=ALARM&amp;tabid=ECS">1.3GB</a>
                            </span>
                        </div>
                        <div class="col-lg-2 summary-module">
                            <span class="summary-font alarmFontMargin">成功</span>
                            <span class="summary-num"><a ui-sref="app.cloud-monitor-alarm({status: 'INSUFFICIENT_DATA', tabid: product.type})" class="color-d alarmNumberSize ng-binding" href="#/app/monitor-alarmmngt-allproduct?status=INSUFFICIENT_DATA&amp;tabid=ECS">11300</a>
                            </span>
                        </div>
                        <div class="col-lg-2 summary-module">
                            <span class="summary-font border-r alarmFontMargin">失败</span>
                            <span class="summary-num"><a ui-sref="app.cloud-monitor-alarm({startStatus: 'false', tabid: product.type})" class="color-e alarmNumberSize ng-binding" href="#/app/monitor-alarmmngt-allproduct?tabid=ECS&amp;startStatus=false">50</a>
                        </span>
                    </div>
                </div>
            </div>
