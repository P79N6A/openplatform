...
<div class="row col-md-12 "
    ...
    <div class="col-md-2 headStyle" align="right">
        <div class="col-md-12" style="font-size: 15px;" align="center">能力提供总流量(MB)</div>
        <div class="col-md-12"style="margin-top: 2%;height: 50%" id="apiProductFlow" align="center"></div>
    </div>
    <div class="col-md-2 headStyle">
        <div class="col-md-12" style="font-size: 15px;" align="center">能力提供总次数(个)</div>
    ...
    $(document).ready(function () {
        ...
        $.post(
            ...
            function (data) {
                ...
                var apiProductFlow = data.apiProductFlow.toString().split("");
                var appCount = data.appCount.toString().split("");
                var apiProductCount = data.apiProductCount.toString().split("");
