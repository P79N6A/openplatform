...
<div id="wrapper">
        ...
        <div class="sidebar-collapse">
            <ul class="nav" id="side-menu">
                <li class="nav-header" style="">
                    ...
                    <div class="logo-element">SESS
                    </div>
                </li>
                <c:forEach items="${menuMap}" var="menu" varStatus="status">
                    <li><a href="#" class=""><i class="fa ${menu.icon}"></i><span class="menu-text">${menu.name}</span><span class="fa arrow"></span></a>
                        <c:if test="${menu.subMenus != null}">
                            <ul class="nav nav-second-level collapse" aria-expanded="true" style="">
                                <c:forEach items="${menu.subMenus}" var="child" varStatus="status1">
                                    <li> <a class="J_menuItem" <c:if test="${child.url != '#'}">href="${child.url}"</c:if> data-index="0"><span class="menu-text">${child.name}</span></a></li>
                                </c:forEach>
                            </ul>
                        </c:if>
                    </li>
    ...
    <div id="page-wrapper" class="gray-bg dashbard-1">
                ...
                <ul class="nav navbar-top-links navbar-right" style="height:40px">
                    <li class="dropdown" onfocus="bindFrameClick()">
                        ...
                        <ul class="dropdown-menu dropdown-alerts">
                            ...
                            <li><a href="javascript:openUserInfo()"><t:mutiLang langKey="common.profile"/></a></li>
                        </ul>
                    </li>
        ...
        <div class="row J_mainContent" id="content-main" style="margin-left:-13px;height:calc(100% - 83px)">
            <iframe class="J_iframe" name="iframe0" width="100%" height="100%" src="isvLogin.do?hplushome" frameborder="0" data-id="loginController.do?hplushome" seamless></iframe>
        </div>
    </div>
</div>
