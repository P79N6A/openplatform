...
function createDataGrid${config_id}(){
	...
	function ${config_id}add(){
		add('${config_name}录入','cgFormBuildController/ftlForm/${config_id}/goAdd.do','${config_id}List',${config_id}Fw,${config_id}Fh);
	}
	//修改
	function ${config_id}update(){
		update('${config_name}编辑','cgFormBuildController/ftlForm/${config_id}/goUpdate.do','${config_id}List',${config_id}Fw,${config_id}Fh);
	}
	//查看
	function ${config_id}view(){
		detail('查看','cgFormBuildController/ftlForm/${config_id}/goDetail.do?mode=read','${config_id}List',${config_id}Fw,${config_id}Fh);
	}
