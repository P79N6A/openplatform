...
function createDataGrid${config_id}(){
	...
	function ${config_id}add(){
		...
		var url ='cgFormBuildController/ftlForm/${config_id}/goAdd.do?olstylecode=${_olstylecode}';
	...
	function ${config_id}update(){
		...
		var url ='cgFormBuildController/ftlForm/${config_id}/goUpdate.do?olstylecode=${_olstylecode}';
		updateNotCreateWin("修改",url, "${config_id}List",false);
	}
	//查看
	function ${config_id}view(){
		var url ='cgFormBuildController/ftlForm/${config_id}/goDetail.do?olstylecode=${_olstylecode}&load=detail';
